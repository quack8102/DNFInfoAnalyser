#include "equipment/h/gunner_27.h"

void Gunner_27::operator() (Character &model) { // 飘零之花步枪
    int P_ATK = 1231, M_ATK = 1057, I_ATK = 711;
...
REGIST(Gunner_27, QString::fromLocal8Bit("飘零之花步枪"));
