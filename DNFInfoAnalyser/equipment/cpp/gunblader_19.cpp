#include "equipment/h/gunblader_19.h"

void Gunblader_19::operator() (Character &model) {
        ...
        if (model.classID == 58) {
            model.addPassiveLevelOUT(20, 20, 3);
        }
    }

REGIST(Gunblader_19, QString::fromLocal8Bit("谍影：超级核心"));
