...
void SettingData::readfile() {
    ...
    if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
        ...
        QMessageBox::critical(NULL, QString::fromLocal8Bit("错误"), QString::fromLocal8Bit("设置文件读取失败"));
    } else {
...
void SettingData::savefile() {
    ...
    if (!file.open(QIODevice::WriteOnly | QIODevice::Text)) {
        ...
        file.close();
        QMessageBox::information(NULL, QString::fromLocal8Bit("DNF面板计算器"), QString::fromLocal8Bit("设置文件保存成功"));
    }
}
